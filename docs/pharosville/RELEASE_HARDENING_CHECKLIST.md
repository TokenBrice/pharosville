...
| 5) Doc drift cleanup | Docs owner | Immediate | Done | Live docs describe the one-renderer Three.js runtime, model/logo media boundary, DOM GPU fallback, and current budgets | `docs/pharosville/ASSET_PIPELINE.md`, `docs/pharosville/TESTING.md`, `docs/pharosville/RUNTIME_FACTS.md`, `docs/pharosville/OPERATIONS.md` |
