...
| --- | --- | --- | --- | --- | --- |
| 1) Enforce merge gate on `main` | Repo admin | Immediate | Done | Branch protection/ruleset requires `typecheck`, `unit`, `guards`, `build`, `visual`, `visual-cross-browser` before merge | `npm run check:branch-protection` |
