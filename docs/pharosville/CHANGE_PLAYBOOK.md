...
| Maintenance guidance | `README.md`, `CURRENT.md`, this file | `README.md`, `AGENTS.md`, `agent/*.md`, `docs/pharosville/*.md`, `docs/pharosville-page.md`, `src/renderer/README.md`, `src/systems/README.md` | Run doc checks when verified docs changed. Keep historical context subordinate to `CURRENT.md`. |
