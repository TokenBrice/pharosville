...
| W7.4 | Record the batched fleet's one route-owned clock and deterministic t=0 reduced-motion pose in the canonical runtime guide, expressed as a composed instance-buffer state rather than per-ship transforms. | reduced-motion tests green |
