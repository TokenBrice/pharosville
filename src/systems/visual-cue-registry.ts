...
export function buildVisualCueRegistry(): VisualCue[] {
  return [
    ...
    },
    {
      ...
      visual: "leg-based routes with 90–180 second logical legs and 240–480 second rests, paired arrivals and departures, and risk-water rests whose local restlessness rises in risk order from calm through watch, alert and warning to danger",
      sourceField: "stablecoins.peggedAssets[].chainCirculating, pegSummary.coins[], stress.signals[], mintBurn.coins[].flowIntensity, ship.id (identity cadence and paired phase)",
      ...
      domEquivalent: "ship detail Route cadence and Cycle tempo rows plus the accessibility-ledger route-cadence clause and legend copy; every surface says routes show rendered-chain/risk presence only, never transfers, bridge volume, transactions, or issuer operations",
    ...
    },
    {
      ...
      visual: "seven low cedar boundary boards on paired pilings naming Calm Anchorage, Watch Breakwater, Alert Channel, Warning Shoals, Danger Strait, Ledger Mooring, and Wreck Shoal; their mixed-case serif lettering gains warm-pale emphasis when the named body is hovered or inspected",
      ...
      domEquivalent: "named area detail panel for all seven waters plus the accessibility ledger Named areas list; the ledger is the redundant channel because canvas boards are aria-hidden",
      reducedMotionEquivalent: "the same static cedar boundary boards with hover emphasis and semantic water texture; the accessibility ledger remains the redundant channel",
    },
    {
