...
export function buildVisualCueRegistry(): VisualCue[] {
  return [
    ...
    },
    {
      ...
      visual: "dock footprint, low broken stone causeways linking Ethereum to its available L2 harbors, and harbor style",
      ...
      reducedMotionEquivalent: "static dock footprint, stone causeways with fixed lantern light, and dock ledger rows",
    },
    {
    ...
    },
    {
      ...
      target: { kind: "dock" },
      primaryChannels: ["shape", "color"],
      visual: "the chain health-factor average dresses healthy quays in clean granite and trimmed lanterns, while weak quays show darker cracked masonry and one leaning bollard",
