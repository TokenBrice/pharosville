...
export const PHAROSVILLE_CHANGELOG: PharosVilleChangelogEntry[] = [
  {
    ...
    date: "2026-09-07",
    title: "Air and Lantern",
    summary: "The harbour gains air, light and planting: distance reads as distance, every window wakes after sunset, the fleet rides the swell, and the garden is finally planted.",
    bullets: [
    ...
    source: "Collected from commits `52c7e12` through `d9c4782` after v0.15.0.",
  },
  {
    id: "2026-09-07-honest-waters",
    version: PHAROSVILLE_RELEASE_VERSIONS.honestWaters,
    date: "2026-09-07",
    title: "Honest Waters",
    summary: "Watch water pulled off the strait, the north-east ladder made honest, the graveyard off the Mole, two berths traded, and the whole garden re-lit in gold over violet shadow.",
    bullets: [
    ...
    source: "Collected from commits `76c7a14` through `a989bfe` and the 2026-09-07 composition consensus work after v0.14.1.",
  },
  {
  ...
  },
  {
    ...
    date: "2026-09-05",
    title: "Epic Pharos",
    summary: "The Great Lighthouse of Alexandria stands on a fortified platform in a closer, warmer harbor — and the deployed site finally shows its real models.",
    bullets: [
    ...
    source: "Collected from commits `f55afbc` through `fddc5ef` after v0.13.0 — the warm village waves and the Epic Pharos rebuild.",
  },
  {
    id: "2026-09-05-clearer-waters",
    version: PHAROSVILLE_RELEASE_VERSIONS.clearerWaters,
    date: "2026-09-05",
    title: "Clearer Waters",
    summary: "More recognizable harbors, cedar sea signs, and roomier boat traffic sharpen the garden around the lighthouse.",
    bullets: [
    ...
    source: "Collected from commit `3443462` after v0.12.0.",
  },
  {
