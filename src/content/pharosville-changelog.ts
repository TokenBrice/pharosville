...
export const PHAROSVILLE_CHANGELOG: PharosVilleChangelogEntry[] = [
  {
    ...
    summary: "Ethereum leaves the west-shore cluster to stand alone as a monumental stone mole — the harbor's counterpart to the lighthouse — while the other chains spread into eight distinct harbor mouths around the whole rim, joined by the TON cote on its own islet.",
    bullets: [
